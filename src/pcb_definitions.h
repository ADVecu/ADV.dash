...
struct pcb_def
{
    ...
    uint16_t width = 800;
    uint16_t hsync_polarity = 0;
    uint16_t hsync_front_porch = 40;
    uint16_t hsync_pulse = 48;
    uint16_t hsync_back_porch = 40;
    uint16_t height = 480;
    uint16_t vsync_polarity = 0;
    uint16_t vsync_front_porch = 1;
    uint16_t vsync_pulse = 31;
    uint16_t vsync_back_porch = 13;
    uint16_t pclk_active_neg = 1;
    int32_t prefer_speed = 15000000;
    bool auto_flush = true;

    // GPIO
    gpio_num_t v5Enable = GPIO_NUM_13;
    gpio_num_t sw12v = GPIO_NUM_10;
    gpio_num_t wakeUp = GPIO_NUM_11;
