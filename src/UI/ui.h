...
LV_IMG_DECLARE(ui_img_leftarrow50_png);    // assets/leftArrow50.png
LV_IMG_DECLARE(ui_img_righarrow50_png);    // assets/righArrow50.png
LV_IMG_DECLARE(ui_img_lowbean50_png);    // assets/lowBean50.png
