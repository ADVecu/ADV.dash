...
extern lv_obj_t * ui_LowBean;
extern lv_obj_t * ui_HighBean;
extern lv_obj_t * ui_FogLight;
extern lv_obj_t * ui_CoolantLvl;
...
LV_IMG_DECLARE(ui_img_righarrow_png);    // assets/righArrow.png
LV_IMG_DECLARE(ui_img_lowbean_png);    // assets/lowBean.png
LV_IMG_DECLARE(ui_img_highbean_png);    // assets/highBean.png
LV_IMG_DECLARE(ui_img_foglight_png);    // assets/fogLight.png
